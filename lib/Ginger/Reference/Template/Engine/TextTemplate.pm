# Ginger::Reference::Template::Engine::TextTemplate
# Version 0.01
...
Ginger::Reference::Template::Engine::TextTemplate - Ginger::Reference Component
...
package Ginger::Reference::Template::Engine::TextTemplate;
...
$VERSION = "0.01";
use Data::Dumper;
use Ginger::Reference::Template::Default;
...
sub init {
    ...
    my $app = $core->get_app();
    $app->register_class( name => 'tpl', file => 'Ginger::Reference::Template::Default' ); 
    $app->register_class( name => 'dummy', file => 'Ginger::Reference::Template::Dummy' ); 
