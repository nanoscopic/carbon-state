# App::Core::Session::Manager::Default
# Version 0.01
...
App::Core::Session::Manager::Default - App::Core Component
...
package App::Core::Session::Manager::Default;
use strict;
use App::Core::Session::Default;
